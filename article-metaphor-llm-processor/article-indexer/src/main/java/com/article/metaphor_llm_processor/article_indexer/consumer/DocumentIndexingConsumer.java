package com.article.metaphor.llm.processor.article_indexer.consumer;

import com.article.metaphor.llm.processor.article_indexer.dto.Article;
import com.article.metaphor.llm.processor.article_indexer.indexing.IndexingReport;
import com.article.metaphor.llm.processor.article_indexer.indexing.RetryableIndexingExecutor;
import com.article.metaphor.llm.processor.article_indexer.repository.DocumentIndexingFailureRepository;
import com.article.metaphor.llm.processor.article_indexer.model.DocumentIndexingAttempt;
import com.article.metaphor.llm.processor.article_indexer.model.DocumentIndexingFailure;
import com.article.metaphor.llm.processor.common.model.OriginType;
