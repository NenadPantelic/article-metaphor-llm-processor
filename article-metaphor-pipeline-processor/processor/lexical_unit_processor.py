...
from model.processing_data import ProcessingData, RawMessage, LexicalUnitProcessingData
...
class LexicalUnitProcessor(StepProcessor):
    def __init__(self):
        super().__init__(ProcessingMilestone.LEXICAL_UNIT_PROCESSING)
    ...
    def execute(self, message: RawMessage) -> ProcessingData:
        ...
        return LexicalUnitProcessingData(lexical_units, unique_lemmas)
